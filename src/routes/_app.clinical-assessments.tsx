...
const config: ModuleConsoleConfig = {
  ...
  businessFlow: {
    ...
    steps: [
      { key: "context", title: "Select patient and context", description: "Pick the patient, ward and clinical context for the assessment.",
        fields: [
          { name: "patient", label: "Patient", required: true },
          { name: "mrn", label: "MRN" },
          { name: "ward", label: "Ward / Unit", required: true },
          { name: "facility", label: "Facility", type: "select", options: ["Life Fourways", "Life Groenkloof", "Life Kingsbury", "Life Vincent Pallotti", "Life The Glynnwood", "Life East London", "Life Westville", "Life Entabeni"] },
        ]},
