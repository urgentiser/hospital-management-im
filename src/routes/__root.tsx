...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "Impilo — Modern Healthcare Platform" },
      {
        name: "description",
        content:
          "Unified clinical, operational, and integration workflows for modern healthcare — one platform, one experience.",
      },
      { property: "og:title", content: "Impilo — Modern Healthcare Platform" },
      {
        property: "og:description",
        content: "Premium API-first frontend for the Impilo modern platform.",
      },
    ...
    links: [
      ...
      {
        rel: "stylesheet",
        href: "https://fonts.googleapis.com/css2?family=Nunito+Sans:opsz,wght@6..12,400;6..12,600;6..12,700;6..12,800;6..12,900&family=Inter:wght@400;500;600;700;800&family=JetBrains+Mono:wght@400;500&display=swap",
      },
    ],
  }),
