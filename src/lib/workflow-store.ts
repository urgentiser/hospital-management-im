...
function seed(): Record<ModuleKey, WorkflowItem[]> {
  ...
  const facilities: WorkflowItem[] = [
    { id: "FAC-001", title: "Sandton Mediclinic", subtitle: "Johannesburg · 240 beds",
      status: "active", fields: { Beds: 240, Wards: 12, Theatres: 6 },
      history: [{ at: nowFmt(), action: "Facility onboarded", by: "Admin" }], createdAt: now(), updatedAt: now() },
    { id: "FAC-002", title: "Netcare Milpark", subtitle: "Johannesburg · 180 beds",
      status: "active", fields: { Beds: 180, Wards: 9, Theatres: 5 },
      history: [{ at: nowFmt(), action: "Facility onboarded", by: "Admin" }], createdAt: now(), updatedAt: now() },
    { id: "FAC-003", title: "Life Fourways", subtitle: "Fourways · 160 beds",
      status: "active", fields: { Beds: 160, Wards: 8, Theatres: 4 },
      history: [{ at: nowFmt(), action: "Facility onboarded", by: "Admin" }], createdAt: now(), updatedAt: now() },
  ];
